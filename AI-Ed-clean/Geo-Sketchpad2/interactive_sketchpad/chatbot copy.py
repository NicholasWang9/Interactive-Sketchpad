...
Another sample problem with objectives:
Find a root of the function f(x)=x^3-x-2 using Newton’s method, starting with an initial guess x_0=3.
...
3) (VERY IMPORTANT) Visualize the graph along with the iterations
