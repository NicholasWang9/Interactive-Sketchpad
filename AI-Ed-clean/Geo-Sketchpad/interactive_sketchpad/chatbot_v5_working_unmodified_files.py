...
Then, ONLY if the file includes a randomized diagram, ask if the student would like another problem of the same type.
If they say yes:
...
async def start_chat():
    ...
    await cl.Message(
        content=("Hello! I'm your AI geometry tutor that can draw. What can I help you with? Here some sample topics:"
         "\n - Angles (e.g. angle bisctor, angle chasing, angles and circles, angles in triangle, vertical angles)"
         ...
         "\n - Rectangles"
         "\n - Similar triangles"
         "\n\nYou can also a specify a difficulty level from Basic, Easy, or Medium.")
    ).send()
