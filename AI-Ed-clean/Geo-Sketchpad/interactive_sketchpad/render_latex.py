...
def pdf_to_png(pdf_path: str, png_path: str, dpi: int = 600) -> None:
    """
    ...
    try:
        ...
        print("pdftocairo not found, falling back to ImageMagick")
        pass
...
def _wrap_snippet_as_document(snippet: str) -> str:
    ...
    """
    return r"""\documentclass[12pt]{amsart}
...
def generate(latex: str, *, dpi: int = 600, snippet: bool = True) -> bytes:
    """
